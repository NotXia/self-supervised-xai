...
class MMBinaryChoiceQAModel(L.LightningModule):
    def __init__(
        self, 
        text_encoder_card, 
        image_encoder_card, 
    ...
    def preprocess(self, image, question):
        return self.image_encoder.preprocess(image), self.text_encoder.preprocess(question)
    ...
    def training_step(self, batch, batch_idx):
        ...
        image_inputs, text_inputs = self.preprocess(image, question)
